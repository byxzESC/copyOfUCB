...
Human.prototype.birthday = (num) => {
  this.age += num;
  console.log(`Happy Birthday ${this.name} on your ${this.age})`);
}
// Create a new Human object with a name of "Blake" and store it inside
// the variable `blake`
const blake = new Human('blake');
...
Human.prototype.talk = () => console.log('Ma. Da.');
...
blake.birthday(1);
Human.prototype.walk = () => console.log('blake walked!');
...
blake.birthday(1);
Human.prototype.talk = () => console.log(`Hello, my name is ${this.name}`);
